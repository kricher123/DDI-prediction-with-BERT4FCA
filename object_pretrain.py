...
class ScaledDotProductAttention(nn.Module):
    ...
    def forward(self, Q, K, V, attn_mask):
        ...
        #v = K.transpose(-1, -2) / msqrt(d_k)
        #scores = torch.bmm(Q.unsqueeze(0).expand_as(v) , v)
...
extent_token_train, object2idx , modified_extents_train, train_object_list  = process_train_extents_from_file('graphs_subset2/graph_numbered_context.txt', 1537)
# print(object2idx)
